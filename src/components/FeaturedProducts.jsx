...
const products = [
    { id: 1, name: 'Handcrafted Ceramic Vase', price: 3600, rating: 4.8, image: 'https://images.unsplash.com/photo-1580480055273-228ff5388ef8?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60', shop: 'Clay & Co.' },
    { id: 2, name: 'Organic Lavender Soap', price: 950, rating: 4.9, image: 'https://images.unsplash.com/photo-1600857062241-98e5dba7f214?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60', shop: 'Nature\'s Best' },
    { id: 3, name: 'Leather Messenger Bag', price: 8500, rating: 4.7, image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60', shop: 'Urban Leather' },
    { id: 4, name: 'Artisan Coffee Beans', price: 1400, rating: 5.0, image: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60', shop: 'Bean There' },
];
